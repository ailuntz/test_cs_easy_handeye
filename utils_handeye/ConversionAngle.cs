...
namespace HandEyeCalibration
{
    public partial class ConversionAngle
    {
        ...
        //将旋转矩阵转换为旋转向量
        public static Mat RotationmatrixToRotVector(Mat Rotationmatrix)
        {
            ...
            //将旋转向量转换为旋转矩阵
        public static Mat RotVectorToRotationmatrix(Mat RotVector,string Seq = "deg")
        {
            ...
            if (Seq =="deg")
            {
                ...
                Cv2.Rodrigues(RotVector, Rotationmatrix);
